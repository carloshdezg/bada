      ...
      <div className="max-w-site mx-auto px-7">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1fr] gap-[52px] mb-[52px]">
          ...
          <div>
            <Link
              href="/"
              className="font-display font-black !text-white text-[28px] tracking-[-0.02em] mb-4 inline-block leading-none hover:!text-white"
            >
          ...
          <div className="flex flex-wrap gap-x-[22px] gap-y-3">
            {[
              ...
              <Link
                key={l.label}
                href={l.href}
                className="text-[12.5px] !text-white hover:!text-white transition-colors"
              >
                {l.label}
              </Link>
            ))}
      ...
      <ul className="list-none space-y-[11px] m-0 p-0">
        {links.map((link) => (
          <li key={link.label}>
            <Link
              href={link.href}
              className="text-[13.5px] !text-white hover:!text-white transition-colors duration-200"
            >
              {link.label}
            </Link>
          </li>
