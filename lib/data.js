...
/* ── Footer ─────────────────────────────────────────────────────── */
// TODO: replace '#' with real hrefs when the /soluciones pages are created
export const FOOTER_SOLUCIONES = [
  { label: 'Para ecommerce',  href: '#' },
  { label: 'Para empresas',   href: '#' },
  { label: 'Para PyMEs',      href: '#' },
]

/** @deprecated Renamed to FOOTER_SOLUCIONES */
export const FOOTER_SERVICES = FOOTER_SOLUCIONES

// TODO: replace '#' with real hrefs when the /servicios/[slug] detail pages are created
export const FOOTER_SERVICIOS = [
  { label: 'Mensajería',            href: '#' },
  { label: 'Paquetería',            href: '#' },
  { label: 'Rutas Dedicadas',       href: '#' },
  { label: 'Logística',             href: '#' },
  { label: 'Envíos para e-commerce', href: '#' },
]

export const FOOTER_EMPRESA = [
  { label: 'Quiénes somos',           href: '/nosotros'                },
  { label: 'Garantías y SLA',         href: '/garantias'               },
  { label: 'Casos de éxito',          href: '/casos'                   },
  { label: 'Blog',                    href: '/blog'                    },
  { label: 'Cobertura',               href: '/cobertura'               },
  { label: 'Rastreo',                 href: '/rastrear'                },
]
